...
- Last recorded fixed pixel-redraw table (2026-09-04, commit `6d4494e` + uncommitted 5/6-minute watch refresh cadence and 30-second phone burst guard — no change to the fixed geometry below, since these changes do not alter invalidated regions):
