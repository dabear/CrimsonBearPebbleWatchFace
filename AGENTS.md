...
- Last recorded fixed pixel-redraw table (2026-09-03, commit `36b1933` — no change to the fixed geometry below, since refreshed screenshots and the patch-version bump do not alter rendering geometry):
