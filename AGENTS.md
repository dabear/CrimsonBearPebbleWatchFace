...
- Last recorded fixed pixel-redraw table (2026-09-03, commit `3d936c7` — no change to the fixed geometry below, since the arrow clear reuses the already-counted content-region transaction):
