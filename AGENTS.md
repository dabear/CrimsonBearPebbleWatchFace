...
- Last recorded fixed pixel-redraw table (2026-09-03, commit `3bba697` — no change to the fixed geometry below, since the Luped palette changes do not alter rendering geometry):
